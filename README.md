...
| `Git Diff Branches` | Show the diff for the current branch against another branch. | |
| `Git Diff Branch Files` | Show the diff for the current file against another branch version. | |
